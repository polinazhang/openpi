...
class LeRobotRobocasaDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        if self.load_dataset_norm_stats and data_dirs is None and self.dataset_soup_keys:
            ...
            data_dirs = []
            for key in self.dataset_soup_keys:
                data_dirs.extend(DATASET_SOUP_REGISTRY[key])
        ...
        if base.norm_stats is None and data_dirs and len(data_dirs) > 0:
...
class TrainConfig:
    ...
    assets_base_dir: str = "/coc/testnvme/xzhang3205/vla-adaptation/models/openpi/assets"
    # Base directory for checkpoints.
    checkpoint_base_dir: str = "/coc/testnvme/xzhang3205/vla-adaptation/models/openpi/checkpoints"
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_franka_on_top_10",
        project_name="pi05_franka_on_top_10",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotFrankaDataConfig(
            repo_id="franka_on_top_10",
            assets=AssetsConfig(asset_id="franka_on_top_10"),
            base_config=DataConfig(prompt_from_task=False),
            dataset_action_dim=8,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
    ...
    TrainConfig(
        name="pi05_franka_on_top_30",
        project_name="pi05_franka_on_top_30",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotFrankaDataConfig(
            repo_id="franka_on_top_30",
            assets=AssetsConfig(asset_id="franka_on_top_30"),
            base_config=DataConfig(prompt_from_task=False),
            dataset_action_dim=8,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
    ...
    TrainConfig(
        name="pi05_franka_object_two_10",
        project_name="pi05_franka_object_two_10",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotFrankaDataConfig(
            repo_id="franka_object_two_10",
            assets=AssetsConfig(asset_id="franka_object_two_10"),
            base_config=DataConfig(prompt_from_task=False),
            dataset_action_dim=8,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
    ...
    TrainConfig(
        name="pi05_franka_object_two_30",
        project_name="pi05_franka_object_two_30",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotFrankaDataConfig(
            repo_id="franka_object_two_30",
            assets=AssetsConfig(asset_id="franka_object_two_30"),
            base_config=DataConfig(prompt_from_task=False),
            dataset_action_dim=8,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
